...
"[project]/src/app/addproduct/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const AddProduct = ()=>{
    _s();
    const addProductValidationSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]().shape({
        name: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().required('Product name is required'),
        ...
        price: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["number"]().required('Price is required').positive('Price must be positive'),
        stock: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["number"]().required('Stock quantity is required').min(0, 'Stock cannot be negative'),
        description: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().required('Description is required'),
        images: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().required('At least one image is required')
    });
    const ProductForm = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$formik$2f$dist$2f$formik$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFormik"])({
        initialValues: {
            name: '',
            brand: '',
            category: '',
        ...
        onSubmit: {
            "AddProduct.useFormik[ProductForm]": (values, param)=>{
                let { resetForm } = param;
                console.log(values);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('http://localhost:5000/product/add', values).then({
                    "AddProduct.useFormik[ProductForm]": (result)=>{
                ...
                }["AddProduct.useFormik[ProductForm]"]).catch({
                    "AddProduct.useFormik[ProductForm]": (err)=>{
                ...
                }["AddProduct.useFormik[ProductForm]"]);
            }
        }["AddProduct.useFormik[ProductForm]"],
...
_s(AddProduct, "hztbkzgWVlLCb56mw/mowJLFpv0=", false, function() {
    return [
...
//# sourceMappingURL=src_app_addproduct_page_jsx_08d06b33._.js.map