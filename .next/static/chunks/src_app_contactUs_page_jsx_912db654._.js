...
function Contact() {
    _s();
    const ContactForm = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$formik$2f$dist$2f$formik$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFormik"])({
        initialValues: {
            name: '',
            email: ''
        },
        onSubmit: {
            "Contact.useFormik[ContactForm]": (values)=>{
                console.log(values);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('http://localhost:5000/contact/add', values).then({
                    "Contact.useFormik[ContactForm]": (result)=>{
                ...
                }["Contact.useFormik[ContactForm]"]).catch({
                    "Contact.useFormik[ContactForm]": (err)=>{
                        console.log(err);
...
_s(Contact, "13buP1dvmlFbaE0VxPgKm3Ho7Ac=", false, function() {
    return [
...
//# sourceMappingURL=src_app_contactUs_page_jsx_912db654._.js.map