...
const AddToCart = ()=>{
    ...
    const handleCheckout = ()=>{
        // Read user and token inside function to avoid SSR issues
        ...
        // Optional: check token expiration using jwt-decode
        try {
            const decoded = JSON.parse(atob(token.split('.')[1]));
            if (decoded.exp * 1000 < Date.now()) {
                localStorage.removeItem("token");
                localStorage.removeItem("user");
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Session expired. Please login again.");
                router.push("/login");
                return;
            }
        } catch (err) {
            ...
            localStorage.removeItem("token");
            localStorage.removeItem("user");
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Invalid session. Please login again.");
            router.push("/login");
            return;
        }
        // Axios request to create order
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("http://localhost:5000/order/add", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__832d5a8e._.js.map